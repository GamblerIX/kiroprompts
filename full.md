...
- **[capabilities.md](#身份定义)** - 核心能力与功能
- **[guidelines.md](#准则)** - 操作指南与标准
- **[response-style.md](#回复风格)** - 沟通风格与语调
- **[quality-standards.md](#质量标准)** - 代码与输出质量要求
- **[workflow-patterns.md](#工作流模式)** - 常用工作流模式与方法
...
**初识规范驱动开发？** → 从 [方法论概述](#模板) 开始  
**准备创建你的第一个规范？** → 跳转到 [流程指南](#模板)  
**正在寻找示例？** → 浏览 [示例与案例研究](#模板)  
**需要模板？** → 获取 [即插即用模板](#模板)  
**与 AI 协作？** → 学习 [提示策略](#模板)

**📍 需要详细导航？** → 查看 [完整导航索引](#完整导航索引) - 按角色、问题或学习风格查找内容
...
学习规范驱动开发背后的基础概念和哲学
- [概述](#方法论概览与哲学) - 核心概念与优势
- [哲学](#方法论概览与哲学) - 为什么规范驱动开发行之有效
- [适用时机](#何时使用规范驱动开发) - 决策框架与场景

#### 📋 [流程指南](#模板)
三阶段工作流的分步演练
- [需求阶段](#需求阶段文档) - 使用 EARS 收集和结构化需求
- [设计阶段](#设计阶段文档) - 创建全面的设计文档
- [任务阶段](#任务阶段文档) - 将设计分解为可操作的编码任务
- [工作流图](#工作流图表与视觉辅助) - 视觉化流程流转与决策点

#### 🧠 [AI 推理](#模板)
洞察决策框架与思维过程
- [决策框架](#ai-决策框架) - 衡量选择的标准
- [思维过程](#ai-思维过程示例) - 分析与优先级排序方法
- [示例](#ai-思维过程示例) - 真实的推理链与决策点

#### 💬 [提示策略](#模板)
与 AI 协作的有效沟通技巧
- [策略](#提示策略) - 核心提示方法
- [模板](#提示模板与模式) - 即插即用的提示模式
- [最佳实践](#提示词最佳实践) - 清晰、有效沟通的技巧

#### ⚡ [执行指南](#模板)
从规范实施功能的实用指导
- [实施指南](#任务执行文档) - 分步执行策略
- [质量保证](#质量保证与测试策略) - 测试与验证技术
- [故障排除](#故障排除与常见陷阱) - 常见问题与解决方案

#### 📚 [资源](#模板)
精选参考资料与学习材料
- [标准](#标准与方法论参考) - EARS 与行业标准
- [工具](#工具与集成指南) - 推荐工具与集成
- [延伸阅读](#资源) - 额外的学习资源

#### 📖 [示例](#模板)
现实世界的案例研究与完整的规范示例
- [简单功能规范](#简单功能规范示例) - 基础功能示例
- [复杂系统规范](#复杂系统规范示例) - 大型系统示例
- [案例研究](#案例研究故障排除与常见陷阱) - 成功案例与经验教训
- [故障排除与陷阱](#故障排除与常见陷阱) - 常见错误与补救策略

#### 📝 [模板](#模板)
即插即用的模板与检查清单
- [需求模板](#需求模板) - EARS 格式的需求
- [设计模板](#设计模板) - 全面的设计结构
- [任务模板](#任务模板) - 实施计划格式
...
1. **理解方法论** - 阅读 [概述](#方法论概览与哲学) 以掌握核心概念
2. **查看实际应用** - 审查一个 [简单功能规范](#简单功能规范示例) 示例
3. **亲自动手尝试** - 使用 [需求模板](#需求模板) 完成你的第一个规范
4. **获得更佳结果** - 在 AI 协作中应用 [提示策略](#提示策略)
...
#### 按工作流阶段
- **规划阶段**：[方法论](#模板) → [需求](#需求阶段文档) → [设计](#设计阶段文档) → [任务](#任务阶段文档)
- **执行阶段**：[实施指南](#任务执行文档) → [质量保证](#质量保证与测试策略)
- **AI 协作**：[提示策略](#模板) → [AI 推理](#模板) → [最佳实践](#提示词最佳实践)

#### 按经验水平
- **初学者**：[方法论](#模板) → [简单示例](#简单功能规范示例) → [模板](#模板)
- **中级**：[流程指南](#模板) → [提示策略](#模板) → [案例研究](#案例研究故障排除与常见陷阱)
- **高级**：[AI 推理](#模板) → [复杂示例](#复杂系统规范示例) → [决策框架](#ai-决策框架)

#### 快速解决问题
- **需求不明确** → [需求阶段](#需求阶段文档) + [EARS 标准](#标准与方法论参考)
- **设计挑战** → [设计阶段](#设计阶段文档) + [AI 决策框架](#ai-决策框架)
- **实施问题** → [实施指南](#任务执行文档) + [故障排除](#故障排除与常见陷阱)
- **AI 沟通问题** → [提示最佳实践](#提示词最佳实践) + [故障排除](#故障排除与常见陷阱)

---

*本指南既作为学习资源，也作为参考手册。根据你当前的需求跳转到任何章节，或者顺序阅读以获得全面的理解。*

**📍 有关按角色、问题或学习风格划分的详细导航，请参阅 [完整导航索引](#完整导航索引)**
## AI 决策框架
...
**📍 你在这里：** [主指南](#模板) → [AI 推理](#模板) → **决策框架**

### 快速导航
- **📚 基础：** [方法论概述](#模板) - 先理解背景
- **📋 应用于设计：** [设计阶段](#设计阶段文档) - 将框架用于设计决策
- **💬 更好的提示：** [提示策略](#提示策略) - 利用对框架的理解进行更好的 AI 协作
- **🏗️ 复杂示例：** [复杂系统规范](#复杂系统规范示例) - 查看框架的应用实例
...
[← 返回决策框架](#ai-决策框架) | [AI 推理主指南](#模板) | [返回主指南](#模板)
...
### 快速导航
- **基础：** [方法论](#模板) - 首先理解规范流程
- **应用学习：** [提示词策略](#提示策略) - 利用洞察力进行更好的 AI 协作
- **查看实践：** [案例研究](#案例研究故障排除与常见陷阱) - AI 推理的真实示例
- **设计上下文：** [设计阶段](#设计阶段文档) - 推理最关键的地方
...
- **[决策框架](#ai-决策框架)** - 方案是如何被评估和优先排序的
- **[思维过程](#ai-思维过程示例)** - 分析方法和推理链
- **[示例](#ai-思维过程示例)** - 带有详细解释的真实决策点
...
**📍 你在这里：** [主指南](#模板) → [示例](#模板) → **案例研究**

### 快速导航
- **📖 学习基础：** [简单功能规范](#简单功能规范示例) - 先查看优秀示例
- **📋 流程帮助：** [流程指南](#模板) - 通过系统化方法避免陷阱
- **💬 更好的提示词：** [最佳实践](#提示词最佳实践) - 更有效地沟通
- **⚡ 执行问题：** [故障排除指南](#故障排除与常见陷阱) - 解决实施问题
...
##### 验收标准
1. 当加载主仪表盘时，页面 应 在 2 秒内渲染完成。
2. 当点击导航链接时，新页面 应 在 1.5 秒内加载。
3. 当提交表单时，系统 应 在 500 毫秒内提供反馈。
4. 如果网络状况较差，系统 应 在 1 秒后显示加载指示器。
...
##### 验收标准
1. 当提供正确的凭据时，系统 应 对用户进行身份验证。
2. 当提供错误的凭据时，系统 应 显示错误。
...
##### 验收标准
1. 当提供正确的凭据时，系统 应 进行身份验证并创建会话。
2. 当提供错误的凭据时，系统 应 显示通用的错误消息。
3. 当登录失败 5 次时，系统 应 临时锁定账户 15 分钟。
4. 当已经在其他地方登录时，系统 应 适当地处理并发会话。
5. 如果账户被锁定，系统 应 提供密码重置选项。
6. 当会话过期时，系统 应 要求重新进行身份验证。
...
##### 验收标准
1. 在构建 UI 时，它 应 使用 React 组件。
2. 在处理状态时，它 应 使用 Redux。
...
##### 验收标准
1. 在与表单交互时，更改 应 立即反映而无需刷新页面。
2. 当数据更新时，界面 应 自动更新。
3. 在使用界面时，它 应 能够在现代 Web 浏览器中运行。
4. 如果禁用了 JavaScript，核心功能 应 仍然可以访问。
...
**📍 你在这里：** [主指南](#模板) → [示例](#模板) → **复杂系统规范**

### 快速导航
- **🎯 从简单开始：** [简单功能规范](#简单功能规范示例) - 先通过基础示例学习
- **🧠 决策帮助：** [AI 决策框架](#ai-决策框架) - 处理复杂选择
- **📋 设计流程：** [设计阶段指南](#设计阶段文档) - 系统化处理复杂性的方法
- **📝 设计模板：** [设计模板](#设计模板) - 复杂设计的结构
...
##### 验收标准
1. 当系统收到请求时，它 应 将其路由到适当的微服务。
2. 当某个服务发生故障时，系统 应 以降级的功能继续运行。
3. 当负载增加时，各个服务 应 能够独立扩展。
4. 如果服务之间需要通信，它们 应 使用定义良好的 API 和消息传递。

#### 需求 2
**用户故事：** 作为一名开发人员，我希望跨服务保持一致的数据管理，以便在分布式系统中维护数据完整性。

##### 验收标准
1. 当一个服务中的数据被修改时，相关服务 应 收到更改通知。
2. 当事务跨越多个服务时，系统 应 确保数据一致性。
3. 当服务暂时不可用时，数据操作 应 被加入队列并重试。
4. 如果发生数据冲突，系统 应 拥有冲突解决策略。

#### 需求 3
**用户故事：** 作为一名 API 使用者，我希望能够统一访问所有服务，以便通过单一接口与系统交互。

##### 验收标准
1. 在发出 API 请求时，客户端 应 使用单一入口点。
2. 当内部服务发生变化时，外部 API 应 保持稳定。
3. 当需要身份验证时，它 应 在所有服务中保持一致。
4. 如果需要速率限制，它 应 统一应用于整个 API。

#### 需求 4
**用户故事：** 作为一名 system administrator，我需要全面的监控和可观测性，以便维护系统的健康和性能。

##### 验收标准
1. 当服务运行时，系统 应 提供健康检查和指标。
2. 当发生错误时，它们 应 跨服务边界被记录和追踪。
3. 当性能下降时，应 触发带有可操作信息的警报。
4. 如果需要调试，分布式的追踪记录 应 对请求流可用。
...
### 示例 2: Real-Time Data Processing Pipeline
#### 概览
...
##### 验收标准
1. 当数据流到达时，系统 应 每秒至少摄取 100,000 个事件。
2. 当摄取负载变化时，系统 应 自动扩展以处理流量高峰。
3. 当数据源暂时不可用时，系统 应 缓冲并重试摄取。
4. 如果数据格式无效，系统 应 记录错误并继续处理有效数据。

#### 需求 2
**用户故事：** 作为一名数据分析师，我需要可配置的数据转换，以便将原始数据处理为有意义的洞察。

##### 验收标准
1. 在处理数据时，系统 应 应用可配置的转换规则。
2. 当转换失败时，系统 应 优雅地处理错误并继续处理。
3. 当需要新的转换逻辑时，其 应 能够在不导致系统停机的情况下进行部署。
4. 如果检测到数据质量问题，系统 应 标记并隔离有问题的数据。

#### 需求 3
**用户故事：** 作为一名业务用户，我需要实时分析和聚合，以便根据当前数据做出及时决策。

##### 验收标准
1. 在处理数据时，系统 应 在 5 秒内计算实时聚合。
2. 当分析结果准备就绪时，其 应 通过多个输出渠道可用。
3. 当需要历史数据时，系统 应 保持可配置的保留期。
4. 如果分析计算失败，系统 应 重试并在持续失败时发出警报。

#### 需求 4
**用户故事：** 作为一名系统管理员，我需要全面的监控和警报，以便确保流水线的可靠性和性能。

##### 验收标准
1. 当流水线运行时，系统 应 提供关于吞吐量和延迟的实时指标。
2. 当发生错误时，其 应 带有足够的调试上下文被记录。
3. 当性能下降时，应 触发带有可操作信息的警报。
4. 如果发生数据丢失，系统 应 立即检测并报告该问题。
...
[← 简单功能示例](#简单功能规范示例) | [案例研究 →](#案例研究故障排除与常见陷阱)
...
### 快速导航
- **先学习：** [方法论概览](#模板) - 了解基础
- **获取模板：** [现成模板](#模板) - 开始编写你自己的规范
- **遵循流程：** [流程指南](#模板) - 分步说明
- **AI 洞察：** [AI 推理示例](#ai-思维过程示例) - 查看决策过程的实际运作
...
- **[简单功能规范](#简单功能规范示例)** - 基础功能的完整示例
- **[复杂系统规范](#复杂系统规范示例)** - 大规模系统开发示例
- **[案例研究](#案例研究故障排除与常见陷阱)** - 成功案例和经验教训
- **[故障排除与常见陷阱](#故障排除与常见陷阱)** - 常见错误和恢复策略
...
**📍 你在这里：** [主指南](#模板) → [示例](#模板) → **简单功能规范**

### 快速导航
- **📚 先学习：** [方法论概览](#模板) - 了解基础
- **📝 使用模板：** [模板](#模板) - 创建你自己的规范
- **📋 遵循流程：** [流程指南](#模板) - 分步说明
- **🏗️ 复杂示例：** [复杂系统规范](#复杂系统规范示例) - 更高级的示例
...
##### 验收标准
1. 当用户提供有效的电子邮件和密码时，系统 应 创建一个新的用户账户。
2. 当用户提供的电子邮件已存在时，系统 应 返回相应的错误消息。
3. 当用户提供的电子邮件格式无效时，系统 应 验证并拒绝该输入。
4. 当用户提供的密码强度较弱时，系统 应 强制执行密码强度要求。

#### 需求 2
**用户故事：** 作为注册用户，我希望使用我的凭据登录，以便访问我的账户和受保护的功能。

##### 验收标准
1. 当用户提供正确的电子邮件和密码时，系统 应 进行身份验证并创建一个会话。
2. 当用户提供错误的凭据时，系统 应 返回身份验证错误。
3. 当用户多次尝试登录失败时，系统 应 实施速率限制。
4. 如果用户已经登录，系统 应 妥善处理现有会话。

#### 需求 3
**用户故事：** 作为已登录用户，我希望我的会话能被安全地维持，这样我就不必频繁重新验证，同时保持安全性。

##### 验收标准
1. 当用户成功登录时，系统 应 创建一个安全的会话令牌（Token）。
2. 当用户发起经过身份验证的请求时，系统 应 验证该会话令牌。
3. 当会话过期时，系统 应 要求重新验证身份。
4. 当用户注销时，系统 应 使相应的会话令牌失效。
...
##### 验收标准
1. 当验证字符串数据时，系统 应 支持长度、模式和格式验证。
2. 当验证数值数据时，系统 应 支持范围、精度和类型验证。
3. 当验证电子邮件地址时，系统 应 使用标准的电子邮件格式验证。
4. 当验证日期时，系统 应 支持格式和范围验证。

#### 需求 2
**用户故事：** 作为一名开发人员，我想要定义自定义验证规则，以便验证特定领域的数据需求。

##### 验收标准
1. 当定义自定义验证器时，系统 应 接收自定义验证函数。
2. 当组合多个验证器时，系统 应 支持验证链（validation chains）。
3. 当验证失败时，系统 应 提供具体的错误消息。
4. 如果验证通过，系统 应 返回经过验证的数据。

#### 需求 3
**用户故事：** 作为一名开发人员，我想要清晰的验证错误消息，以便向用户提供有意义的反馈。

##### 验收标准
1. 当验证失败时，系统 应 返回描述性的错误消息。
2. 当多个验证失败时，系统 应 收集所有错误消息。
3. 当显示错误时，系统 应 识别哪个字段验证失败。
4. 如果提供了自定义错误消息，系统 应 使用它们而不是默认消息。
...
**📍 你在这里：** [主指南](#模板) → [示例](#模板) → **故障排除与陷阱**

### 快速导航
- **📋 学习流程：** [流程指南](#模板) - 通过系统化方法避免陷阱
- **💬 更好的沟通：** [提示词最佳实践](#提示词最佳实践) - 防止误解
- **⚡ 实施问题：** [执行故障排除](#故障排除与常见陷阱) - 解决编码问题
- **📖 真实案例：** [案例研究](#案例研究故障排除与常见陷阱) - 从实际失败中学习
...
##### 验收标准
1. 当用户点击“编辑资料”时，系统 应 显示一个包含当前资料数据的可编辑表单。
2. 当用户提交有效的资料更改时，系统 应 在 2 秒内保存更改。
3. 当用户输入无效数据时，系统 应 在表单内显示具体的错误消息。
...
**📍 你在这里：** [主指南](#模板) → [执行指南](#模板) → **实施指南**

### 快速导航
- **📋 前置要求：** [任务阶段](#任务阶段文档) - 学习如何创建实施计划
- **📝 任务模板：** [任务模板](#任务模板) - 结构化你的实施计划
- **📖 查看示例：** [简单功能任务](#简单功能规范示例) - 完整的任务示例
- **✅ 质量控制：** [质量保证](#质量保证与测试策略) - 保持代码质量
...
### 快速导航
- **前置要求：** [任务阶段](#任务阶段文档) - 学习如何创建实施计划
- **完整示例：** [简单功能规范](#简单功能规范示例) - 查看从规范到代码的完整工作流
- **实用工具：** [工具与资源](#工具与集成指南) - 推荐的执行工具
- **流程概览：** [三阶段工作流](#模板) - 理解完整上下文
...
### 快速导航
- **下一步：** [流程指南](#模板) - 学习分步工作流
- **查看示例：** [简单功能规范](#简单功能规范示例) - 查看实际应用中的方法论
- **开始：** [需求模板](#需求模板) - 开始你的第一个规范
...
#### 初识规范驱动开发
1. [方法论概览](#模板) - 理解基础
2. [简单功能示例](#简单功能规范示例) - 查看实际应用
3. [需求模板](#需求模板) - 亲自尝试
4. [流程指南](#模板) - 学习完整工作流

#### 准备创建你的第一个规范
1. [需求模板](#需求模板) - 从这里开始
2. [需求阶段指南](#需求阶段文档) - 详细指令
3. [EARS 标准](#标准与方法论参考) - 格式参考
4. [提示词策略](#提示策略) - 获取更好的 AI 协助

#### 与 AI 系统协作
1. [提示词策略](#模板) - 核心沟通技巧
2. [AI 决策框架](#ai-决策框架) - 理解 AI 推理
3. [最佳实践](#提示词最佳实践) - 避免常见错误
4. [故障排除](#故障排除与常见陷阱) - 解决问题

#### 根据规范实施
1. [实施指南](#任务执行文档) - 系统地执行任务
2. [质量保证](#质量保证与测试策略) - 保持代码质量
3. [任务模板](#任务模板) - 结构化你的实施计划
4. [执行故障排除](#模板) - 处理实施问题
...
#### 核心方法论
- [方法论概览](#模板) - 哲学与方法
- [何时使用](#何时使用规范驱动开发) - 决策框架
- [流程指南](#模板) - 三阶段工作流
- [工作流图示](#工作流图表与视觉辅助) - 视觉化流程图

#### 分步指南
- [需求阶段](#需求阶段文档) - 将构思转化为需求
- [设计阶段](#设计阶段文档) - 创建技术架构
- [任务阶段](#任务阶段文档) - 分解为实施步骤
- [实施指南](#任务执行文档) - 执行计划

#### 模板与工具
- [需求模板](#需求模板) - EARS 格式化结构
- [设计模板](#设计模板) - 全面的设计框架
- [任务模板](#任务模板) - 实施规划格式
- [检查清单](#规范流程检查表) - 质量验证清单
...
- [简单功能规范](#简单功能规范示例) - 基础功能示例
- [复杂系统规范](#复杂系统规范示例) - 大型系统示例
- [案例研究](#案例研究故障排除与常见陷阱) - 成功案例与教训
- [故障排除示例](#故障排除与常见陷阱) - 常见错误

#### AI 协作
- [提示词策略](#提示策略) - 核心沟通方法
- [提示词模板](#提示模板与模式) - 即插即用模式
- [最佳实践](#提示词最佳实践) - 有效技术
- [AI 决策框架](#ai-决策框架) - AI 如何做出选择

#### 参考资料
- [EARS 标准](#标准与方法论参考) - 需求语法参考
- [工具与资源](#工具与集成指南) - 推荐工具
- [工具集成](#规范流程的工具集成指南) - 安装与配置

### 🎭 按用户角色

#### 开发人员
**从这里开始：** [简单功能示例](#简单功能规范示例)
- [实施指南](#任务执行文档) - 系统地执行规范
- [质量保证](#质量保证与测试策略) - 保持代码质量
- [故障排除](#故障排除与常见陷阱) - 解决常见问题
- [AI 推理](#ai-决策框架) - 理解 AI 决策

#### 项目经理
**从这里开始：** [方法论概览](#模板)
- [何时使用](#何时使用规范驱动开发) - 决策框架
- [流程指南](#模板) - 三阶段工作流
- [案例研究](#案例研究故障排除与常见陷阱) - 成功案例
- [复杂系统示例](#复杂系统规范示例) - 大型项目示例

#### 技术主管
**从这里开始：** [流程指南](#模板)
- [设计阶段](#设计阶段文档) - 架构与技术决策
- [AI 决策框架](#ai-决策框架) - 决策洞察
- [复杂系统规范](#复杂系统规范示例) - 高级示例
- [质量保证](#质量保证与测试策略) - 质量标准
...
#### “我不知道从哪里开始”
→ [方法论概览](#模板) → [简单示例](#简单功能规范示例) → [需求模板](#需求模板)

#### “我的需求不清晰/模糊”
→ [需求阶段指南](#需求阶段文档) → [EARS 标准](#标准与方法论参考) → [故障排除](#故障排除与常见陷阱)

#### “我需要技术设计方面的帮助”
→ [设计阶段指南](#设计阶段文档) → [AI 决策框架](#ai-决策框架) → [复杂示例](#复杂系统规范示例)

#### “我的 AI 协作效果不佳”
→ [提示词策略](#提示策略) → [最佳实践](#提示词最佳实践) → [故障排除](#故障排除与常见陷阱)

#### “我在实施过程中卡住了”
→ [实施指南](#任务执行文档) → [质量保证](#质量保证与测试策略) → [执行故障排除](#模板)

#### “我需要针对特定情况的示例”
→ [简单功能](#简单功能规范示例) → [复杂系统](#复杂系统规范示例) → [案例研究](#案例研究故障排除与常见陷阱)
...
#### 问题解决者
1. [故障排除指南](#故障排除与常见陷阱)
2. [案例研究](#案例研究故障排除与常见陷阱)
3. [最佳实践](#提示词最佳实践)
4. [质量保证](#质量保证与测试策略)

### 🔗 交叉引用图谱
#### 需求 ↔ 相关内容
- **需求阶段** ↔ [EARS 标准](#标准与方法论参考), [需求模板](#需求模板)
- **用户故事** ↔ [简单示例](#简单功能规范示例), [故障排除](#故障排除与常见陷阱)
- **验收标准** ↔ [EARS 参考](#标准与方法论参考), [质量保证](#质量保证与测试策略)

#### 设计 ↔ 相关内容
- **设计阶段** ↔ [AI 决策框架](#ai-决策框架), [设计模板](#设计模板)
- **架构决策** ↔ [复杂示例](#复杂系统规范示例), [案例研究](#案例研究故障排除与常见陷阱)
- **技术研究** ↔ [提示词策略](#提示策略), [最佳实践](#提示词最佳实践)

#### 任务 ↔ 相关内容
- **任务阶段** ↔ [实施指南](#任务执行文档), [任务模板](#任务模板)
- **任务分解** ↔ [质量保证](#质量保证与测试策略), [简单示例](#简单功能规范示例)
- **实施规划** ↔ [执行指南](#模板), [工具参考](#工具与集成指南)

#### AI 协作 ↔ 相关内容
- **提示词** ↔ [AI 推理](#模板), [决策框架](#ai-决策框架)
- **沟通** ↔ [最佳实践](#提示词最佳实践), [故障排除](#故障排除与常见陷阱)
- **理解 AI** ↔ [思维过程](#ai-思维过程示例), [案例研究](#案例研究故障排除与常见陷阱)

### 🏷️ 主题标签

#### 按复杂度级别
- **初级**：[方法论](#模板), [简单示例](#简单功能规范示例), [模板](#模板)
- **中级**：[流程指南](#模板), [提示词策略](#模板), [实施指南](#任务执行文档)
- **高级**：[AI 推理](#模板), [复杂示例](#复杂系统规范示例), [决策框架](#ai-决策框架)

#### 按阶段
- **需求**：[需求阶段](#需求阶段文档), [EARS 标准](#标准与方法论参考), [需求模板](#需求模板)
- **设计**：[设计阶段](#设计阶段文档), [决策框架](#ai-决策框架), [设计模板](#设计模板)
- **任务**：[任务阶段](#任务阶段文档), [实施指南](#任务执行文档), [任务模板](#任务模板)

#### 按内容类型
- **流程**：[流程指南](#模板), [工作流图示](#工作流图表与视觉辅助)
- **示例**：[示例](#模板), [案例研究](#案例研究故障排除与常见陷阱)
- **模板**：[模板](#模板), [检查清单](#规范流程检查表)
- **参考**：[资源](#模板), [标准](#标准与方法论参考)
...
**📍 您当前所在位置：** [主指南](#模板) → [流程指南](#模板) → **设计阶段**

### 快速导航
- **🎯 开始使用：** [设计模板](#设计模板) - 即插即用的模板
- **📖 查看示例：** [复杂系统规范](#复杂系统规范示例) - 完整的设计示例
- **🧠 决策辅助：** [AI 决策框架](#ai-决策框架) - 如何评估选择
- **➡️ 下一阶段：** [任务阶段](#任务阶段文档) - 设计获批后的下一步

### 阶段导航
- **上一阶段：** [需求阶段](#需求阶段文档) - 必须首先完成
- **当前阶段：** **设计阶段** - 创建技术架构和计划
- **下一阶段：** [任务阶段](#任务阶段文档) - 分解为实施步骤
- **上下文：** [流程概览](#模板) - 三阶段工作流
...
### 快速导航
- **前提条件：** [方法论概览](#模板) - 首先理解基础
- **模板：** [即插即用的模板](#模板) - 快速开始
- **示例：** [查看完整规范](#模板) - 从真实示例中学习
- **AI 辅助：** [提示词策略](#模板) - 有效地与 AI 协作
...
- **[需求阶段](#需求阶段文档)** - 使用 EARS 格式收集并结构化需求
- **[设计阶段](#设计阶段文档)** - 通过研究创建全面的设计文档
- **[任务阶段](#任务阶段文档)** - 将设计分解为可操作的编码任务
- **[工作流图表](#工作流图表与视觉辅助)** - 可视化的流程图和决策点
...
#### 相关章节
- [示例](#模板) - 查看完整的流程示例
- [提示词策略](#模板) - 获得更好的 AI 协作
- [执行指南](#模板) - 实施您已完成的规范

[← 返回主指南](#模板) | [从需求开始 →](#需求阶段文档)
...
**📍 您当前所在位置：** [主指南](#模板) → [流程指南](#模板) → **需求阶段**

### 快速导航
- **🎯 开始使用：** [需求模板](#需求模板) - 即插即用的模板
- **📖 查看示例：** [简单功能规范](#简单功能规范示例) - 完整的需求示例
- **📚 学习 EARS：** [标准参考](#标准与方法论参考) - EARS 格式详情
- **➡️ 下一阶段：** [设计阶段](#设计阶段文档) - 需求获批后的下一步

### 阶段导航
- **上一阶段：** [流程概览](#模板) - 三阶段工作流
- **当前阶段：** **需求阶段** - 将思路转化为结构化需求
- **下一阶段：** [设计阶段](#设计阶段文档) - 创建技术架构
- **最终阶段：** [任务阶段](#任务阶段文档) - 分解为实施步骤
...
**简单事件-响应**：
当 [用户点击提交按钮] 则 [系统] 应 [验证表单数据]

**条件行为**：
如果 [用户已通过身份验证] 则 [系统] 应 [显示用户仪表板]

**复杂条件**：
当 [用户提交表单] AND [所有必填字段已完成] 则 [系统] 应 [处理提交内容]

**错误处理**：
当 [用户提交无效数据] 则 [系统] 应 [显示特定错误消息]

#### 高级 EARS 模式

**基于状态的需求**：
当 [系统处于维护模式] 则 [系统] 应 [向所有用户显示维护消息]

**性能需求**：
当 [用户请求数据] 则 [系统] 应 [在 2 秒内响应]
...
**验收标准**：
1. 当 用户提供有效的电子邮件和密码 时，系统应 创建新账户
2. 当 用户提供已存在的电子邮件 则 系统 应 显示“电子邮件已注册”错误
3. 当 用户提供无效的电子邮件格式 则 系统 应 显示“无效的电子邮件格式”错误
4. 当 用户提供的密码短于 8 个字符 则 系统 应 显示“密码太短”错误
5. 当 账户创建成功 则 系统 应 发送确认邮件
6. 当 账户创建成功 则 系统 应 重定向到欢迎页面
...
**验收标准**：
1. 当 用户在必填字段中输入数据 时，系统应 移除任何错误高亮
2. 当 用户提交带有空必填字段的表单 则 系统 应 以红色高亮显示缺失字段
3. 当 用户输入无效的数据格式 则 系统 应 在字段下方显示格式要求
4. 当 所有验证通过 则 系统 应 启用提交按钮
5. 如果 验证失败，则 系统 应 保持提交按钮禁用
...
**验收标准**：
1. 当 用户选择小于 10MB 的文件 时，系统应 接受文件进行上传
2. 当 用户选择超过 10MB 的文件 则 系统 应 显示“文件过大”错误
3. 当 用户选择不支持的文件类型 则 系统 应 显示“格式不支持”错误
4. 当 上传正在进行中 则 系统 应 显示进度指示器
5. 当 上传成功完成 则 系统 应 显示成功消息
6. 当 上传失败 则 系统 应 显示重试选项
7. 如果 用户未通过身份验证，则 系统 应 在上传前重定向到登录界面

### 常见陷阱及如何避免

#### 陷阱 1：需求模糊
**问题**：“系统应该运行很快”
**解决方案**：“当 用户请求数据 则 系统 应 在 2 秒内响应”

#### 陷阱 2：需求中包含实施细节
**问题**：“系统应使用 Redis 进行缓存”
**解决方案**：“当 用户请求频繁访问的数据 则 系统 应 返回缓存结果”

#### 陷阱 3：缺失错误情况
**问题**：仅定义“快乐路径”场景
**解决方案**：始终为错误条件包含 当/如果 语句
...
#### 陷阱 5：不可测试的需求
**问题**：“系统应该是用户友好的”
**解决方案**：“当 新用户完成引导流程 则 系统 应 要求点击次数不超过 3 次即可到达主要功能”
...
**📍 您当前所在位置：** [主指南](#模板) → [流程指南](#模板) → **任务阶段**

### 快速导航
- **🎯 开始使用：** [任务模板](#任务模板) - 即插即用的模板
- **📖 查看示例：** [简单功能任务](#简单功能规范示例) - 完整的任务示例
- **⚡ 执行任务：** [实施指南](#任务执行文档) - 如何逐步完成任务
- **🔄 返回起点：** [需求阶段](#需求阶段文档) - 完整的工作流上下文

### 阶段导航
- **上一阶段：** [设计阶段](#设计阶段文档) - 必须首先完成
- **当前阶段：** **任务阶段** - 将设计分解为可操作的步骤
- **下一阶段：** [实施](#任务执行文档) - 执行这些任务
- **上下文：** [流程概览](#模板) - 三阶段工作流
...
**📍 您在这里：** [主指南](#模板) → [提示策略](#模板) → **最佳实践**

### 快速导航
- **📚 学习策略：** [提示策略](#提示策略) - 首先了解核心方法
- **📝 使用模板：** [提示模板](#提示模板与模式) - 即插即用的模式
- **🧠 理解 AI：** [决策框架](#ai-决策框架) - AI 如何做出选择
- **🔧 解决问题：** [故障排除指南](#故障排除与常见陷阱) - 当提示出现问题时
...
- Do they start with 当, 如果, WHERE, WHILE?
- Is the system response clearly specified with 应?
- 条件和触发器是否具体且可测试？”
...
### 快速导航
- **基础：** [方法论概述](#模板) - 首先理解规范驱动开发
- **流程步骤：** [流程指南](#模板) - 学习三阶段工作流
- **AI 推理：** [决策框架](#ai-决策框架) - 理解 AI 如何做出选择
- **实践：** [模板](#模板) - 尝试使用结构化模板进行提示
...
- **[策略](#提示策略)** - 清晰、有效的提示核心方法
- **[模板](#提示模板与模式)** - 适用于每个阶段的即开即用的提示模式
- **[最佳实践](#提示词最佳实践)** - 获得更好结果的建议
...
### 快速导航
- **应用标准：** [需求阶段](#需求阶段文档) - 在实践中使用 EARS 格式
- **获取模板：** [模板与检查清单](#模板) - 即开即用的起点
- **理解上下文：** [方法论](#模板) - 了解资源如何融入大局
- **寻找工具：** [工具集成指南](#规范流程的工具集成指南) - 具体的工具建议
...
- **[标准](#标准与方法论参考)** - EARS 格式和行业需求工程标准
- **[工具](#工具与集成指南)** - 用于规范开发的推荐工具和集成
- **[进一步阅读](#资源)** - 书籍、文章和其他学习资源

### 快速参考

#### EARS 格式
**E**asy **A**pproach to **R**equirements **S**yntax - 一种用于编写清晰、可测试需求的结构化方法，使用 当, 如果, WHILE, WHERE 和 应 等关键字。
...
**📍 您在这里：** [主指南](#模板) → [资源](#模板) → **标准**

### 快速导航
- **📋 应用 EARS：** [需求阶段](#需求阶段文档) - 在实践中使用 EARS 格式
- **📝 使用模板：** [需求模板](#需求模板) - EARS 格式的模板
- **📖 查看示例：** [简单功能规范](#简单功能规范示例) - EARS 的实际应用
- **🔧 更多工具：** [工具与资源](#工具与集成指南) - 其他有用的资源
...
**格式：** `当 [事件/触发器] 则 [系统] 应 [响应]`

**示例：**
- 当 用户点击“保存”按钮 则 系统 应 验证所有表单字段
- 当 文件上传超过 10MB 则 系统 应 显示错误消息
- 当 用户会话过期 则 系统 应 重定向到登录页面
...
**示例：**
- 如果 用户未经身份验证 则 系统 应 拒绝访问受保护的资源
- 如果 数据库连接失败 则 系统 应 显示维护消息
- 如果 用户具有管理员特权 则 系统 应 显示管理面板

##### WHILE (持续性需求)
用于在持续运行期间必须维持的需求。

**格式：** `WHILE [条件] [系统] 应 [持续行为]`

**示例：**
- WHILE 文件正在上传 系统 应 显示进度指示器
- WHILE 用户正在输入 系统 应 提供实时验证反馈
- WHILE 系统正在处理请求 系统 应 防止重复提交

##### WHERE (可选需求)
用于仅在特定上下文或位置适用的需求。

**格式：** `WHERE [位置/上下文] [系统] 应 [行为]`

**示例：**
- WHERE 用户在移动设备上 系统 应 使用响应式布局
- WHERE 应用程序在生产模式下运行 系统 应 将错误记录到外部服务
- WHERE 多个用户同时编辑 系统 应 优雅地处理冲突
...
1. 当 [event] 时，系统应 [response]
2. 如果 [condition]，则 [system] 应 [response]
...
[← 工具参考](#工具与集成指南) | [检查表 →](#规范流程检查表) | [返回资源](#模板)
...
[← 标准](#标准与方法论参考) | [检查表 →](#规范流程检查表) | [返回资源](#模板)
...
**📍 您当前的位置：** [主指南](#模板) → [模板](#模板) → **设计模板**

### 快速导航
- **📚 学习流程：** [设计阶段指南](#设计阶段文档) - 如何使用此模板
- **📖 查看示例：** [复杂系统设计](#复杂系统规范示例) - 实际应用中的模板
- **🧠 决策帮助：** [决策框架](#ai-决策框架) - 如何做出设计选择
- **➡️ 下一个模板：** [任务模板](#任务模板) - 设计完成后
...
### 快速导航
- **学习流程：** [流程指南](#模板) - 了解如何使用这些模板
- **查看示例：** [完整示例](#模板) - 在实践中填写的模板
- **标准参考：** [EARS 与标准](#标准与方法论参考) - 格式指南
- **从这里开始：** [需求模板](#需求模板) - 开始您的第一份规范
...
1. **新功能？** 从 [需求模板](#需求模板) 开始
2. **需求已完成？** 进入 [设计模板](#设计模板)  
3. **设计已完成？** 使用 [任务模板](#任务模板)
4. **需要示例？** 查阅 [示例](#模板) 部分

---

[← 返回主指南](#模板) | [获取需求模板 →](#需求模板)
...
**📍 您当前的位置：** [主指南](#模板) → [模板](#模板) → **需求模板**

### 快速导航
- **📚 学习流程：** [需求阶段指南](#需求阶段文档) - 如何使用此模板
- **📖 查看示例：** [简单功能需求](#简单功能规范示例) - 实际应用中的模板
- **📋 EARS 参考：** [标准指南](#标准与方法论参考) - EARS 格式详情
- **➡️ 下一个模板：** [设计模板](#设计模板) - 需求完成后
...
1. 当 (当) [特定事件或触发器] 时，[系统名称] 应当 (应) [特定的系统响应]
2. 如果 (如果) [条件或状态]，那么 [系统名称] 应当 (应) [必需的行为]
3. 当 (WHILE) [持续进行的条件] 时，[系统名称] 应当 (应) [持续的行为]
4. 在 (WHERE) [情境或位置] 的情况下，[系统名称] 应当 (应) [特定情境下的行为]
...
#### 性能需求
- 当 (当) [负载条件] 时，[系统名称] 应当 (应) [性能标准]
- 如果 (如果) [使用场景]，那么 [系统名称] 应当 (应) [响应时间要求]

#### 安全需求
- 当 (当) [安全事件] 时，[系统名称] 应当 (应) [安全响应]
- 如果 (如果) [身份验证条件]，那么 [系统名称] 应当 (应) [访问控制行为]

#### 易用性需求
- 当 (当) [用户交互] 时，[系统名称] 应当 (应) [易用性标准]
- 如果 (如果) [无障碍条件]，那么 [系统名称] 应当 (应) [无障碍合规性]

#### 可靠性需求
- 当 (当) [故障条件] 时，[系统名称] 应当 (应) [恢复行为]
- 如果 (如果) [错误状态]，那么 [系统名称] 应当 (应) [错误处理响应]
...
- ✅ 缺点ider edge cases and error conditions
...
**Event-Driven (当)**
- User actions: "当 user clicks submit button"
- System events: "当 data sync completes"
- Time-based: "当 daily backup runs"
...
[← Back to Templates](#模板) | [Design Template →](#设计模板)
...
**📍 你在这里：** [主指南](#模板) → [模板](#模板) → **任务模板**

### 快速导航
- **📚 学习流程：** [任务阶段指南](#任务阶段文档) - 如何使用此模板
- **📖 查看示例：** [简单功能任务](#简单功能规范示例) - 实践中的模板示例
- **⚡ 执行任务：** [实施指南](#任务执行文档) - 如何逐步完成任务
- **🔄 重新开始：** [需求模板](#需求模板) - 完整工作流
